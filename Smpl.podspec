...
Pod::Spec.new do |s|
  s.name             = 'Smpl'
  s.version          = '0.1.0'
  s.summary          = 'A short description of Smpl.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/cangokceaslan/Smpl'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'cangokceaslan' => '48398625+cangokceaslan@users.noreply.github.com' }
  s.source           = { :git => 'https://github.com/cangokceaslan/Smpl.git', :tag => s.version.to_s }
  ...
  s.dependency 'ReSwift', '~> 6.1.0'
	s.dependency 'ExytePopupView', '~> 1.2'
